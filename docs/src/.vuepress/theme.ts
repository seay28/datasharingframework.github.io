...
export default hopeTheme({
 ...
 navbar: [
  ...
  },
  {
    ...
    icon: "note",
    // children:["/v1/"],
    children: [{ text: "v1.3.1 (stable)", link: "/stable/" }, { text: "v1.3.0", link: "/v1.3.0/" }, { text: "v1.2.0", link: "/v1.2.0/" }, { text: "v1.1.0", link: "/v1.1.0/" }, { text: "v1.0.0", link: "/v1.0.0/" }, { text: "v0.9.3 (oldstable)", link: "/oldstable/"}],
  },
  {
    text: "",
    icon: "github",
