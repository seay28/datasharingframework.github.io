...
icon: customize
---
 [Authentication](authentication.md) | Network Setup and General Architecture
...
![<b>Network Setup Diagramm</b>](/photos/guideline/generalInformation/highmed_dsf_network_setup.svg)
...
![<b>Network Setup Diagramm</b>](/photos/guideline/generalInformation/highmed_dsf_network_setup_ext_dmz.svg)
